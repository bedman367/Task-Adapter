...
frame_path = '/DATA/xxxxxx/Datasets/ucf101/frames'
\
data_path = '/DATA/xxxxxx/ucf101'
output = '/DATA/xxxxxx/Datasets/ucf101/annotations'
...
for dataset in dataset_list:
    ...
    for i, classfile_list in enumerate(classfile_list_all):
        ...
        if 'val' in dataset:
            # if (i%4 == 1):
            if i > 69 and i <=79: #if i+1 > 31 and i+1 <=41: i > 63 and i <=75
