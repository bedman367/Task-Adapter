...
frame_path = '/DATA/xxxxxx/Datasets/kinetics/frames'
data_path = '/DATA/xxxxxx/kinetics_100'
output = '/DATA/xxxxxx/Datasets/kinetics/annotations'
...
for dataset in dataset_list:
    ...
    for i, classfile_list in enumerate(classfile_list_all):
        ...
        if 'val' in dataset:
            # if (i%4 == 1):
            if i > 63 and i <=75: #if i+1 > 31 and i+1 <=41: i > 63 and i <=75
